...
const StyledButton = styled.button<{ variant?: ButtonVariant }>`
    ...
    border: none;
    color: ${props => ((props.variant && props.variant === ButtonVariant.Sell) || 
        (props.variant && props.variant === ButtonVariant.Buy)) ? props.theme.componentsTheme.buttonBuySellTextColor : props.theme.componentsTheme.buttonTextColor};
    cursor: pointer;
    display: flex;
    font-size: 14px;
    font-weight: 600;
